...
wcfromvector(fleas$What.made.you.decide.to.listen.to.the.show., 100, grams = 1)
```
...
# plot.new()
# text(x=0.5, y=0.5, "What Made You Decide to Listen to the Show")
wcfromvector(fleas$What.made.you.decide.to.listen.to.the.show.,user_stp_words = c("like"), 100, grams = 2)
```
